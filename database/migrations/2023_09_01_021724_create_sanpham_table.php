...
class CreateSanphamTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('san_pham', function (Blueprint $table) {
            ...
            $table->timestamp('ThoiGianTao')->default(DB::raw('CURRENT_TIMESTAMP'))->comment('Thời điểm tạo # Thời điểm đầu tiên tạo sản phẩm');
            $table->timestamp('ThoiGianCapNhap')->default(DB::raw('CURRENT_TIMESTAMP'))->comment('Thời điểm cập nhật # Thời điểm cập nhật sản phẩm gần nhất');
