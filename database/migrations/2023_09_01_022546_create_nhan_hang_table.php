...
class CreateNhanHangTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('nhan_hang', function (Blueprint $table) {
            ...
            $table->timestamp('ThoiGianTao')->default(DB::raw('CURRENT_TIMESTAMP'))->comment('Thời điểm tạo # Thời điểm đầu tiên tạo nhãn hàng');
            $table->timestamp('ThoiGianCapNhap')->default(DB::raw('CURRENT_TIMESTAMP'))->comment('Thời điểm cập nhật # Thời điểm cập nhật nhãn hàng gần nhất');
        });
    }
